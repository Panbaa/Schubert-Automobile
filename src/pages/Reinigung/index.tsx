...
function Reinigung() {
  return (
    <div className='flex-grow p-4 space-y-5'>
      ...
      <img src="src\assets\Vorher-Nachher\Autositz.png" alt="Vorher-Nachher-Vergleich eines Autositzes" />
      ...
      <ScrollingGallery images={["src\\assets\\Vorher-Nachher\\RotesAuto.png", "src\\assets\\Vorher-Nachher\\Autositz.png"]} />
